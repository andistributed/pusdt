...
var networkDefaultConfig = PaymentConfig{
	Coin:            "USDT",
	Network:         "TRC20",
...
// 网络配置映射
var networkConfigs = map[string]PaymentConfig{
	"usdt.erc20": {
		Coin:            "USDT",
		Network:         "ERC20",
...
func (c PaymentConfig) NetworkLabel() string {
	return model.GetTradeTypeLabel(strings.ToLower(c.Network))
}
